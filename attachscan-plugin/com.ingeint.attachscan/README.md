...
- New callout
    * Name: CName
    * Package: com.ingeint.attachscan.callout
    * Example: com.ingeint.attachscan.callout.CStringFormat

- New process
    * Name: PName
    * Package: com.ingeint.attachscan.process
    * Example: com.ingeint.attachscan.process.PGenerateWithholding

- New form
    * Name: FName
    * Package: com.ingeint.attachscan.form
    * Example: com.ingeint.attachscan.form.FMultiPayment

- New event
    * Name: EName
    * Package: com.ingeint.attachscan.event
    * Example: com.ingeint.attachscan.event.EAfterCompleteInvoice

- New model (extends class X)
    * Name: MName
    * Package: com.ingeint.attachscan.model
    * Example: com.ingeint.attachscan.model.MTableExample

## Folder estructure

```
    com.ingeint.attachscan
        |_.settings
...
- New callout
    * Create callout in package `com.ingeint.attachscan.callout`, extends from `CustomCallout`
    * Register callout in `com.ingeint.attachscan.component.CalloutFactory`. Example:
...
- New process
    * Create process in package `com.ingeint.attachscan.process`, extends from `CustomProcess`
    * Register process in `com.ingeint.attachscan.component.ProcessFactory`. Example:
...
- New form
    * Create form in package `com.ingeint.attachscan.form`, extends from `CustomForm`
    * Register form in `com.ingeint.attachscan.component.FormFactory`. Example:
...
- New event
    * Create event in package `com.ingeint.attachscan.event`, extends from `CustomEvent`
    * Register event in `com.ingeint.attachscan.component.EventFactory`. Example:
...
- New model (extends form class X)
    * Create model in package `com.ingeint.attachscan.model`, extends class `X`. Example: `X_TL_TableExample -> MTableExample`
    * Register model in `com.ingeint.attachscan.component.ModelFactory`. Example:
