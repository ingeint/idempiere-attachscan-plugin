...
public class SCUIStandard {
	public static final ImageIcon LOGO = new ImageIcon(SCUIFeature.get("PATH_IMAGE") + "logo.png");
	public static final Image ICON = new ImageIcon(SCUIFeature.get("PATH_IMAGE") + "logo16px.png").getImage();
}
