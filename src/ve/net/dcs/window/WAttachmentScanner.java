 ...
 * @author Low Heng Sin
 * 
 * ("loadImageFromScanner getImageFromScanner", 2013-11, Double Click Sistemas, Saul Piña spina@dcs.net.ve)
 * 
 */
public class WAttachmentScanner extends Window implements EventListener<Event> {
	...
	void staticInit() throws Exception {
		...
		bScan.setImageContent(new AImage("ve.net.dcs.AttachmentScannerAction", WAttachmentScanner.class.getResourceAsStream("/action/images/ve.net.dcs.AttachmentScannerAction24.png")));
	...
	private void getImageFromScanner() {
		WSelectScanner win = new WSelectScanner(this);
		AEnv.showWindow(win);
	}
	...
	public void loadImageFromScanner(byte[] image, String fileName) {
		...
		if (m_attachment.addEntry(fileName, image)) {
